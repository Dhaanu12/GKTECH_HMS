...
import { UserPlus, Stethoscope, Users, Briefcase, UserCog, TrendingUp, Syringe } from 'lucide-react';
...
export default function UserManagementPage() {
    ...
    const tabs = [
        ...
        { id: 'nurses', label: 'Nurses', icon: Syringe, component: NursesPage },
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-600 text-sm">Manage hospital staff and administrators.</p>
            </div>
