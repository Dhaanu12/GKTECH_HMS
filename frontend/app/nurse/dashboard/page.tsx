            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border ${shift === 'Day'
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${entry.visit_status === 'Completed'
