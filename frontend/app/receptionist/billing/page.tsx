...
import { Search, Calendar, Filter, Printer, Eye, CreditCard, Clock, CheckCircle, User, FileText, Stethoscope, X, Phone, Tag } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 max-w-[1600px] mx-auto p-4 md:p-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-4 text-xs font-bold uppercase tracking-wide">
                                                <span className="bg-slate-100 text-slate-700 px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">MRN: {bill.mrn_number}</span>
                                            ...
                                            {(bill.doctor_name || bill.department_name) && (
                                                <div className="flex items-center gap-4 text-slate-600 bg-slate-50 p-4 rounded-xl border border-slate-100">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="font-bold text-slate-800 text-sm truncate max-w-[180px]">{bill.doctor_name || 'Unknown Doctor'}</span>
                                    ...
                                    <div>
                                        <div className="flex justify-between items-start mb-5">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-base text-slate-800 font-extrabold uppercase tracking-tight">OPD: {item.opd_number}</p>
                                                    <p className="text-xs text-slate-500 font-medium mt-0.5">{new Date(item.visit_date).toLocaleDateString()}</p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <div className="flex flex-wrap gap-2 mb-4 text-xs font-bold uppercase tracking-wide">
                                                <span className="bg-slate-100 text-slate-700 px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">MRN: {item.mrn_number}</span>
                                                <span className="bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg border border-emerald-100 shadow-sm flex items-center gap-1.5 text-sm">
                                            ...
                                            <div className="flex items-center gap-4 text-slate-600 bg-slate-50 p-4 rounded-xl border border-slate-100 mb-4">
                                                <div className="p-2 bg-white rounded-lg text-amber-500 shadow-sm shrink-0">
                                                    <Stethoscope className="w-5 h-5" />
                                                </div>
                                                <div className="flex flex-col">
                                                    <span className="font-bold text-slate-800 text-sm truncate max-w-[180px]">{item.doctor_name}</span>
                                            ...
                                            <div className="px-2 text-xs text-slate-700 font-bold flex items-center gap-2 uppercase tracking-wide">
            ...
            {showInvoice && selectedBill && (
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 print:p-0 print:bg-white print:absolute print:inset-0 print-modal">
