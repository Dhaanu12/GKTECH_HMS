...
class ClientAdmin extends BaseModel {
    constructor() {
    ...
    async findAllWithDetails() {
        const query = `
            SELECT DISTINCT s.*, u.username, u.email, u.phone_number,
            ...
            WHERE s.staff_type = 'ADMIN' AND s.is_active = true
        `;
...
module.exports = new ClientAdmin();
